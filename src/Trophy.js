...
const Trophy = ({ colour }) => (
  <div className="m-15 max-w-20">
    ...
    >
      <g>
        <path
          d="M204.013,358.2c-8.7,0-15.8,7.101-15.8,15.8c0,1.801,0.3,3.4,0.8,5h102c0.5-1.6,0.8-3.3,0.8-5c0-8.699-7.1-15.8-15.8-15.8
    ...
    H204.013z"
        />
        <path
          d="M350.213,474.6V416.4c0-3-2.601-5.5-5.8-5.5h-15.7c-3.2,0-5.8-2.5-5.8-5.5v-10.1c0-3-2.601-5.5-5.801-5.5h-41.1h-72h-41.5
    ...
    C347.513,480.1,350.213,477.6,350.213,474.6z"
        />
        <path
          d="M476.213,11.9c-0.601-6.5-6.7-11.9-13.2-11.9H17.113c-6.8,0-12.6,5.2-13.2,11.9c-4.6,50.8,15.2,102.1,50.6,138.4
